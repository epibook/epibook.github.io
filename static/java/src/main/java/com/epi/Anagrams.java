...
letters of one set of words, you get another set of words. For example, ``eleven plus
two'' is an anagram for ``twelve plus one''.
Crossword puzzle enthusiasts and Scrabble players benefit from the ability to view all possible anagrams of a given set of letters.
