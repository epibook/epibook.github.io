...
Your gas tank has unlimited capacity. Call a city {\em ample} if you can begin at that
city with an empty tank,
refill at it, then travel through all the remaining cities, refilling at each, and return to
