...
public class S1 extends SpellCheckService {
  ...
  public static void main(String [] args ) {
    ...
    while ( true ) {
      ...
      try {Thread.sleep(100,300);} catch (Exception e) {e.printStackTrace();}
      synchronized (acomm) {
...
class Spell {
  public static String [] closestInDictionary(String w) { try {Thread.sleep(100,300);} catch (Exception e) {e.printStackTrace(); }; return new String[] {w}; }
}
