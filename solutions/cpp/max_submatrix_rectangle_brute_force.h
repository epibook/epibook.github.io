...
#ifndef SOLUTIONS_CPP_MAX_SUBMATRIX_RECTANGLE_BRUTE_FORCE_H_
#define SOLUTIONS_CPP_MAX_SUBMATRIX_RECTANGLE_BRUTE_FORCE_H_
...
#endif  // SOLUTIONS_CPP_MAX_SUBMATRIX_RECTANGLE_BRUTE_FORCE_H_
