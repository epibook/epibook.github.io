...
#ifndef SOLUTIONS_CPP_SMALLEST_SUBARRAY_COVERING_SET_H_
#define SOLUTIONS_CPP_SMALLEST_SUBARRAY_COVERING_SET_H_
...
// @exclude
#endif  // SOLUTIONS_CPP_SMALLEST_SUBARRAY_COVERING_SET_H_
